...
if ((a >= 1000) && (a < 1000000)) { 
        b = (string_copy(string((c / 1000)+0.001), 0, 4) + " K");
}
if ((a >= 1000000) && (a < 1000000000)) { 
    b = string_copy(string((c / 1000000)+0.001), 0, 4) + " M";
}
if ((a >= 1000000000) && (a < 1000000000000)) { 
    b = string_copy(string((c / 1000000000)+0.001), 0, 4) + " B";
}
if ((a >= 1000000000000) && (a < 1000000000000000)) { 
    b = string_copy(string((c / 1000000000000)+0.001), 0, 4) + " T";
}
if ((a >= 1000000000000000) && (a < 1000000000000000000)) { 
    b = string_copy(string((c / 1000000000000000)+0.001), 0, 4) + " Qa";
};
return (b);
