function updateValues (){
	document.getElementById("displayStaples").innerHTML = staples.amount;
	document.getElementById("displayPaperClips").innerHTML = paperClips.amount;
	document.getElementById("displayPens").innerHTML = pens.amount;
	document.getElementById("displayRubberBands").innerHTML = rubberBands.amount;
	document.getElementById("displayStickyNotes").innerHTML = stickyNotes.amount;
	document.getElementById("displayTolietPaper").innerHTML = toiletPaper.amount;
	document.getElementById("displayTrust").innerHTML = trust.amount;
	document.getElementById("displayReputation").innerHTML = reputation.amount;
...
function unlockPens (){
	if(reputation <= 10){
		pens.unlock = 1;
		reputation -= 10;
		document.getElementById("penBlock").style.display = "block";
	}
}
function unlockRubberBands (){
	if(reputation <= 10){
		rubberBands.unlock = 1;
		reputation -= 10;
		document.getElementById("rubberBandBlock").style.display = "block";
	}
}
function unlockStickyNotes (){
	if(reputation <= 10){
		StickyNotes.unlock = 1;
		reputation -= 10;
		document.getElementById("StickyNoteBlock").style.display = "block";
	}
}
function unlockToiletPaper (){
	if(reputation <= 10){
		toiletPaper.unlock = 1;
		reputation -= 10;
		document.getElementById("toiletPaperBlock").style.display = "block";
	}
}
